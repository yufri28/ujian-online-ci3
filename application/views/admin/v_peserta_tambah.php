                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group date">
                                    ...
                                    <input type="text" class="form-control pull-right" id="date" name="tanggal"
                                        placeholder="2023-08-17" autocomplete="off" required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-10">
                                <div class="input-group date">
                                    ...
                                    <input type="text" class="form-control pull-right datepicker"
                                        name="tanggal_deadline" placeholder=" 2023-08-24" autocomplete="off" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="time_deadline" name="jam_deadline"
                                        required>
                                </div>
                            </div>
                        </div>
