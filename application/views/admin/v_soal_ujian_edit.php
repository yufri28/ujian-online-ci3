                ...
                <div class="box-body">
                    <div  class="form-horizontal">
                            ...
                            <div class="col-sm-10">
                                <select class="select2 form-control" name="nama_matapelajaran" required="">
                                    ...
                                    <?php foreach($matapelajaran as $a) { ?>
                                      <option value="<?=$a->id_matapelajaran?>" <?= $s->nama_matapelajaran==$a->nama_matapelajaran?"selected":""; ?>><?= $a->kode_matapelajaran;?> | <?= $a->nama_matapelajaran;?></option>
                                  <?php } ?>
                                </select>
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select class="select2 form-control" name="nama_kelas" required="">
                                        <option selected="selected" disabled="" value="">- Pilih Kelas -</option>
                                        <?php foreach ($kelas as $a) { ?>
                                            <option value="<?= $a->id_kelas; ?>" <?= $s->id_kelas==$a->id_kelas?"selected":""; ?>><?= $a->nama_kelas; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
