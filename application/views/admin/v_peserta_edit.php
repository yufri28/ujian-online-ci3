                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select class="select2 form-control" name="peserta" required>
                                    ...
                                    <option value="<?= $a->id_siswa ?>"
                                        <?php if ($a->nama_siswa == $p->nama_siswa) {echo "selected='selected'";} ?>>
                                        <?= $a->nis; ?> | <?= $a->nama_siswa; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select class="select2 form-control" name="mapel" required value="">
                                    ...
                                    <option value="<?= $a->id_matapelajaran ?>"
                                        <?php if ($p->nama_matapelajaran == $a->nama_matapelajaran) { echo "selected='selected'";} ?>>
                            ...
                            <div class="col-sm-10">
                                <div class="input-group date">
                                    ...
                                    <input type="text" class="form-control pull-right datepicker"
                                        name="tanggal_deadline" placeholder="2023-08-24"
                                        value="<?= $p->tanggal_deadline;?>" required>
                                </div>
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="col-sm-2 control-label">Jam Deadline</label>
                            <div class="col-sm-10">
                                <div class="input-group">
                                    <div class="input-group-addon">
                                        <i class="fa fa-clock-o"></i>
                                    </div>
                                    <input type="text" class="form-control" value="<?= $p->jam_deadline;?>"
                                        id="time_deadline" name="jam_deadline" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select class="select2 form-control" name="jenis" required value="">
                                    ...
                                    <option value="<?= $a->id_jenis_ujian ?>"
                                        <?php if ($p->jenis_ujian == $a->jenis_ujian) { echo "selected='selected'";} ?>>
                                        <?= $a->jenis_ujian; ?>
                                    </option>
                                    <?php } ?>
                                </select>
